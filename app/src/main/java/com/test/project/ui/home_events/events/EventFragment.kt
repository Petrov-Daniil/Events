...
import com.test.project.databinding.EventFragmentBinding
...
class EventFragment : Fragment(R.layout.event_fragment) {
    ...
    private val binding: EventFragmentBinding by viewBinding()
    private val model: HomeEventViewModel by viewModel()
    private val adapterEventList: EventListAdapter = EventListAdapter()
